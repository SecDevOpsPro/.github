...
[![Website](https://img.shields.io/badge/Website-secdevopspro.com-2AC7B8?style=for-the-badge&logo=google-chrome&logoColor=white)](https://secdevopspro.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-SecDevOpsPro-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/company/secdevopspro)
[![Email](https://img.shields.io/badge/Email-contact@secdevopspro.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:contact@secdevopspro.com)
...
graph LR
    ...
    D --> E[Monitor]
    E --> A
    style A fill:#1F3351,stroke:#2AC7B8,stroke-width:2px,color:#fff
    style B fill:#1F3351,stroke:#2AC7B8,stroke-width:2px,color:#fff
    style C fill:#1F3351,stroke:#2AC7B8,stroke-width:2px,color:#fff
    style D fill:#1F3351,stroke:#2AC7B8,stroke-width:2px,color:#fff
    style E fill:#1F3351,stroke:#2AC7B8,stroke-width:2px,color:#fff
```
